...
For each assumption you consider violated, provide an explanation for why this may be the case. (Hint: We'll be dealing with some of these problems when we into the multivariate regression model setting). __(4. pts)__
