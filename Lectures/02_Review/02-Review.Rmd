...
Problem set 1 is posted. Will post next one upon deadline of the previous.
This will allow folks more time/flexibility to get homework(s) organized. 

- Due next Monday on Canvas by 1pm.
- Analytical and computational components (turned in separately).
- Each homework due every 2 weeks, Monday 1pm, last homework graded within week 10.

Issues with .mono[R]?

- Office hours times included here.
...
- Random Variable X: Win 1USD if heads ($x_i=$), pay 1USD if tails ($x_i=-1$)
