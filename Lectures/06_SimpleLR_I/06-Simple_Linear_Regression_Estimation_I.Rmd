...
**Problem Set 3** to be released in a week! (Jan 31st)

- Will be focused on simple linear regressions and underlying assumptions

- Will not be due until **after** your midterm exam (Feb 7th)

- Computational component will be using recent lab knowledge
...
2. Summate the squared residuals, $RSS = \sum_{i=1}^n \hat{u}_i$
