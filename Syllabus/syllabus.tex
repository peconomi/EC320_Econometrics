...
\begin{table}[h!]
	...
	\begin{tabular}{@{\extracolsep{0.5cm}} c c l @{}}
		...
		01 & 01/07 & Lab: Introduction to \texttt{R} and \texttt{RStudio} \\ 
		02 & 01/10 & \textbf{Problem Set 1} (due on Canvas by 5pm)  \\
		02 & 01/14 & Lab: Introduction to the \texttt{tidyverse} \\ \midrule 
		03 & 01/17 & \textbf{Quiz 1}: \textit{Basics} (due on Canvas by 11:59pm) \\
		03 & 01/21 & Lab: Visualization using \texttt{ggplot2} \\
		04 & 01/24 & \textbf{Problem Set 2} (due on Canvas by 5pm)  \\ 
		04 & 01/28 & Lab: Regression Analysis \\ 
		05 & 01/31 & \textbf{Problem Set 3} (due on Canvas by 5pm) \\ 
		05 & 02/04 & {\it No Lab}, focus on midterm prep \\  \midrule
		06 & 02/11 & Lab: Hypothesis Testing and Confidence Intervals \\
		07 & 02/18 & \textbf{Problem Set 4} (due on Canvas by 5pm)  \\ 
		07 & 02/18 & Lab: Omitted-Variable Bias and Hypothesis Testing \\
		08 & 02/23 & \textbf{Quiz 2}: \textit{Regressions} (due on Canvas by 11:59pm) \\ 
		08 & 02/25 & Lab: Maps on \texttt{R} + [taking requests] \\ \midrule
		09 & 03/01 & {\bf Data project}  \\  
		09 & 03/04 & Lab: Interaction terms and non-linear relationships \\
		10 & 03/07 & \textbf{Problem Set 5} (due on Canvas by 5pm) \\
		10 & 03/11 & Lab: Accounting for heteroskedasticity and autocorrelation \\ \bottomrule
	\end{tabular}
\end{table}
